...
var womendiv = document.querySelector(".womendiv")
var womeninfor = document.querySelector(".womeninfor")

class FireBaseWorkerWomen{
    fireBaseRef;
    constructor(){
...
// getwomen
var getwomen = new FireBaseWorkerWomen()
getwomen.women()